...
# 데어터셋 : Naver Sentiment Movie Corpus(https://github.com/e9t/nsmc/)
...
#'c:\python_workspace\MovieTomatoes\ai\dataset\rating_train.txt' # 절대경로
...
# 절대경로와 상대경로
# C:\python_workspace\MovieTomatoes
#                           ㄴ ai
#                                ㄴ dataset
#                                     ㄴ ratings_text.txt
#                                     ㄴ ratings_train.txt
